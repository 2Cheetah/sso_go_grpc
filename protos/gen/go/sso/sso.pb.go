...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth JWT of the logged user
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x15, 0x32, 0x43, 0x68, 0x65, 0x65, 0x74, 0x61, 0x68, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
